...
#no sabia que era una tabal hash, pero aprendi que una tabla hash es como un archivador con muchos cajones enumerados mientras que una lista ordenada que es similar es como un diccionario
"""
